...
public class LogInController implements Initializable {
    ...
    public JFXPasswordField passwordInput2;
    @FXML
    private JFXTextField SSNInput;
    ...
    public boolean validateLogin() throws SQLException {
        ...
        if (SSNInput.getText ().equals ("") || passwordInput2.getText ().equals ("")) {
            errorMassage ();
        } else {
            DataBaseHandler DBHandler = new DataBaseHandler ();
            String check = DBHandler.checkLogInIfEmployee (SSNInput.getText (), new PassWordHash ().encrypt (passwordInput2.getText (), secretKey));
            switch (check) {
                case "1":
                    isManager = true;
                    return true;
                ...
                case "10":
                    ...
                    String check2 = dataBaseHandler.checkLogInIfCustomer (SSNInput.getText (), new PassWordHash ().encrypt (passwordInput2.getText (), secretKey));
                    switch (check2) {
                        case "1":
                            isCustomer = true;
                            return true;
